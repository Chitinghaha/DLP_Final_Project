...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Comma-separated classes to forget, e.g. 0,1,2. Overrides --class_to_replace when set.",
    )
    parser.add_argument(
        "--incremental_forget_only",
        action="store_true",
        help="Forget only the current --class_to_replace while excluding older classes in --classes_to_replace from all train loaders.",
    )
